...
export const ShapeEditor = () => {
  ...
  const [borderRadius, setBorderRadius] = useState({
    topLeft: 41, //we can remove later
    topRight: 59,
    bottomRight: 59,
    bottomLeft: 41,
    top: 37,
  ...
  const generateCSS = () => {
    return `border-radius: ${borderRadius.topLeft}% ${borderRadius.topRight}% ${borderRadius.bottomRight}% ${borderRadius.bottomLeft}% / ${borderRadius.top}% ${borderRadius.right}% ${borderRadius.bottom}% ${borderRadius.left}%;
    ...
    <div className="flex flex-col items-center p-5 bg-gray-100 rounded-lg font-sans">
      <div 
        ...
        style={{
          height: `${height}px`,
          width: `${width}px`,
          borderRadius: `${borderRadius.topLeft}% ${borderRadius.topRight}% ${borderRadius.bottomRight}% ${borderRadius.bottomLeft}% / ${borderRadius.top}% ${borderRadius.right}% ${borderRadius.bottom}% ${borderRadius.left}%`,
          background: `linear-gradient(to bottom, ${colors.start} 0%, ${colors.end} 100%)`
        }}
      />
